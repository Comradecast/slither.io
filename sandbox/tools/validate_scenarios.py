...
class ScenarioRunner:
    ...
    def run_scenario(
        ...
        result.update({
            ...
            "collision_threat_distance": eval_result.collision_threat_distance,
            "collision_threat_angle_deg": eval_result.collision_threat_angle_deg,
            "collision_corridor_density": eval_result.collision_corridor_density,
            "collision_forward_cone": eval_result.collision_forward_cone,
            "collision_lateral_offset": eval_result.collision_lateral_offset,
            "threat_receding": eval_result.threat_receding,
            "threat_persistent_frames": eval_result.threat_persistent_frames,
            "threat_confidence": eval_result.threat_confidence,
            "enemy_intercept_heading_delta_deg": eval_result.enemy_intercept_heading_delta_deg,
            "my_radius": state.my_radius,
